 ...
 */
export function areBoxesInCollision(
    firstBoxDimensions: Dimensions,
    firstBoxPosition: Point,
    secondBoxDimensions: Dimensions,
    secondBoxPosition: Point,
): boolean {
    const isNotIntersectingHorizontally =
        firstBoxPosition.x >= secondBoxDimensions.width + secondBoxPosition.x ||
        secondBoxPosition.x >= firstBoxDimensions.width + firstBoxPosition.x;
    const isNotIntersectingVertically =
        firstBoxPosition.y >=
            secondBoxDimensions.height + secondBoxPosition.y ||
        secondBoxPosition.y >= firstBoxDimensions.height + firstBoxPosition.y;
